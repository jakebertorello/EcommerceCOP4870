                ...
                switch(choice)
                {
                    ...
                    do
                    {
                        ...
                        switch(choice)
                        {
                            case 'A':
                            case 'a':
                                Console.WriteLine("What item would you like to add to cart?");
                                string? name = Console.ReadLine();
                                Console.WriteLine("How many?");
                                int quant = int.Parse(Console.ReadLine() ?? "-1");
                                
                                var item = new Product {Name = name, quantity = quant};
                                ShoppingCartServiceProxy.Current.Add(item);
                            ...
                            case 'u':
                                Console.WriteLine("Which product would you like to update?");
                                int selection = int.Parse(Console.ReadLine() ?? "-1");
                                var selectedProd = cart.FirstOrDefault(p => p?.Id == selection);
